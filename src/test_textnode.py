...
class TestTextNode(unittest.TestCase):
    ...
    def test_repr(self):
        ...
        node_str = "TextNode(This is a text node, link, https://www.test.com)"
    ...
    def test_text_node_to_html_node_image(self):
        node = TextNode("image alt text", TextType.IMAGE, "https://www.testimage.com")
        html_node = text_node_to_html_node(node)
        self.assertEqual(html_node.tag, "img")
        self.assertEqual(html_node.value, "")
        self.assertEqual(
            html_node.props,
            {"src": "https://www.testimage.com", "alt": "image alt text"},
        )
